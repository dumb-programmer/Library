...
let myLibrary = [
  //   new Book("JavaScript The Good Parts", "Douglas Croford", 170, false, document.createElement()),
...
okBtn.addEventListener("click", (event) => {
  ...
  if (title.value == "") {
    title.setCustomValidity("Title field can't be empty");
    title.reportValidity();
  } else if (author.value == "") {
    author.setCustomValidity("Author field can't be empty");
    author.reportValidity();
  } else if (pages.value == "") {
    pages.setCustomValidity("Pages field can't be empty");
